...
Reference showing proper JSON structure. Replace IDs, labels, positions, and colors based on discovered components.
...
Columns (x): 120, 320, 520, 720, 920
```

## Diagram Complexity Guidelines

<table>
<tr><th>Complexity</th><th>Max Elements</th><th>Max Arrows</th><th>Approach</th></tr>
<tr><td>Simple</td><td>5-10</td><td>5-10</td><td>Single file, no groups</td></tr>
<tr><td>Medium</td><td>10-25</td><td>15-30</td><td>Use grouping rectangles</td></tr>
<tr><td>Complex</td><td>25-50</td><td>30-60</td><td>Split into multiple diagrams</td></tr>
<tr><td>Very Complex</td><td>50+</td><td>60+</td><td>Multiple focused diagrams</td></tr>
</table>

**When to split:** More than 50 elements. Create: `architecture-overview.excalidraw`, `architecture-data-layer.excalidraw`

**When to use groups:** 3+ related services, same deployment unit, logical boundaries (VPC, Security Zone)
