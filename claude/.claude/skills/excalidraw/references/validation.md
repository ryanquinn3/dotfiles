...
### Labels don't appear inside shapes
...
### Arrow appears disconnected/floating
...
### Arrow endpoint doesn't reach target
...
### Multiple arrows from same source overlap
...
### Callback arrow doesn't loop correctly
...
### Arrows are curved, not 90-degree
